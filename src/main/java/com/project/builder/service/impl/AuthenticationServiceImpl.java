package com.project.builder.service.impl;

import com.project.builder.dto.AdminDTO;
import com.project.builder.dto.AuthDataDTO;
import com.project.builder.dto.LoginDTO;
import com.project.builder.dto.TokenValidationDTO;
import com.project.builder.dto.UserDTO;
import com.project.builder.entity.Admin;
import com.project.builder.entity.User;
import com.project.builder.repository.AdminRepository;
import com.project.builder.repository.UserRepository;
import com.project.builder.response.CustomApiResponse;
import com.project.builder.service.AuthenticationService;
import com.project.builder.utils.JwtUtils;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public CustomApiResponse<?> registerAdmin(AdminDTO adminDTO) {
        try {
            ...
            String accessToken = jwtUtils.generateAccessToken(adminDTO.getUsername(), adminDTO.getRole());
            String refreshToken = jwtUtils.generateRefreshToken(adminDTO.getUsername(), adminDTO.getRole());
    ...
    public CustomApiResponse<?> registerUser(UserDTO userDTO) {
        try {
            ...
            String accessToken = jwtUtils.generateAccessToken(userDTO.getUsername(), userDTO.getRole());
            String refreshToken = jwtUtils.generateRefreshToken(userDTO.getUsername(), userDTO.getRole());
